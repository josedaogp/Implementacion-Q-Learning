...
public class Estado2 {
	...
	/*Constructor*/
	//1100 estados
	public Estado2(int arr, int ab, int iz, int der, int arrDer, int arrIz, int DirGasolina) {
		this.arriba = arr;
		this.abajo = ab;
		this.izquierda = iz;
		this.derecha = der;
	...
	public Estado2(StateObservation Ob) {
	...
	private String funcionHash(Estado2 estado) {
	...
	public boolean compararEstados(Estado2 a) {
