...
import PaqueteVideo2DistanciaYDireccion.TablaQ;
import PaqueteVideo2DistanciaYDireccion.*;
 ...
 */
public class TestDistanciaYDireccion {
    ...
    public static void main(String[] args) {
		...
		try {
			...
			ArcadeMachine.runOneGame(game, level1, visuals, "PaqueteVideo2DistanciaYDireccion.AgentTestEstado", recordActionsFile, seed, 0);
		...
		String level111 = new String(game).replace(gameName, gameName + "_lvl" + 0);
		String level3 = new String(game).replace(gameName, gameName + "_lvl" + 1);
		...
		//ArcadeMachine.runGames(game, new String[]{level5,level6,level7,level8,level9,level10,level11,level12,level13,level14,level15,level16,level17,level3,level111,level17,level16,level7,level15,level9,level111,level3,level7,level8,level9,level10,level11,level12,level13,level14,level15,level16,level17,level5,level6,level17,level16,level7,level15,level9,level5,level6,level7,level8,level9,level10,level11,level12,level13,level14,level15,level16,level17,level3,level111,level17,level16,level7,level15,level9,level111,level3,level7,level8,level9,level10,level11,level12,level13,level14,level15,level16,level17,level5,level6,level17,level16,level7,level15,level9,level5,level6,level7,level8,level9,level10,level11,level12,level13,level14,level15,level16,level17,level3,level111,level17,level16,level7,level15,level9,level111,level3,level7,level8,level9,level10,level11,level12,level13,level14,level15,level16,level17,level5,level6,level17,level16,level7,level15,level9}, M, "PaqueteVideo2DistanciaYDireccion.AgentEstado", null);//120
		ArcadeMachine.runGames(game, new String[]{level111,level3,level111,level111,level3}, M, "PaqueteVideo2DistanciaYDireccion.AgentEstado", null);//5
